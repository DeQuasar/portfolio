...
<template>
  ...
  <section
    ...
    class="relative isolate flex min-h-[calc(100svh-1.5rem)] flex-col items-center overflow-hidden rounded-none px-4 pb-[calc(env(safe-area-inset-bottom)+2.25rem)] pt-[calc(env(safe-area-inset-top)+2.75rem)] text-center shadow-none sm:min-h-0 sm:rounded-[2.2rem] sm:px-10 sm:py-14 sm:shadow-card"
  >
    <div
