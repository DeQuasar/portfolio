...
<template>
  <CardSurface
    ...
    class="group relative flex flex-col gap-6 overflow-hidden border border-[color:var(--border-soft)] bg-white shadow-md transition-shadow duration-300 ease-out sm:shadow-[0_18px_44px_-30px_rgba(28,40,31,0.35)]"
    :class="[
